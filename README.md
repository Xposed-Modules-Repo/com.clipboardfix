...
在 HyperOS 3.0（Android 16）+上，系统应用「剪贴板与常用语V4.7.7」应用会阻止第三方输入法（如微信输入法等）访问剪贴板历史数据，导致第三方输入法无法使用系统剪贴板功能，官方内置输入法（搜狗小米定制版、讯飞小米定制版、百度小米定制版、小米智能输入法）不受影响。
